...
광고효과 기록·대조(기획안 6.14)는 P2다. 16.2 업로드와 16.3 Upstage·Solar
지표 추출 FastAPI endpoint, 업로드·추출의 영속·AI 기반은 구현됐다.
16.4~16.5 두 공개 endpoint는 아직 `planned`며 runtime에 등록하지 않는다.
